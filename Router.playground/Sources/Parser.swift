...
public func parse(tokens: [Token], context: RouteVertex = RouteVertex(pattern: ""), terminalHandler: RouteVertex.HandlerType) -> RouteVertex {
    let root = context
...
func parseLParen(context: RouteVertex, var sequence: IndexingGenerator<Array<Token>>, terminalHandler: RouteVertex.HandlerType) {
...
func parseSlash(context: RouteVertex, var sequence: IndexingGenerator<Array<Token>>, terminalHandler: RouteVertex.HandlerType) {
...
func parseDot(context: RouteVertex, var sequence: IndexingGenerator<Array<Token>>, terminalHandler: RouteVertex.HandlerType) {
    let pattern = context.pattern + "."
...
func parseLiteral(context: RouteVertex, value: String, var sequence: IndexingGenerator<Array<Token>>, terminalHandler: RouteVertex.HandlerType) {
...
func parseSymbol(context: RouteVertex, value: String, var sequence: IndexingGenerator<Array<Token>>, terminalHandler: RouteVertex.HandlerType) {
    let pattern = context.pattern + ":\(value)"
...
func parseStar(context: RouteVertex, value: String, var sequence: IndexingGenerator<Array<Token>>, terminalHandler: RouteVertex.HandlerType) {
    let pattern = context.pattern + "*\(value)"
